...
public class ObjectPoolManager : MonoBehaviour
{
	...
	public static GameObject CreatePooled( GameObject prefab, Transform parentTransform )
	{
		return Instance.InternalCreate( prefab, parentTransform);
	}
	...
	private GameObject InternalCreate( GameObject prefab, Transform parentTransform)
	{
		ObjectPool pool;
		...
		GameObject obj = pool.Instaniate( parentTransform );
